...
As of this update, I am still finalizing the 3D modeling for the device enclosure, which will be a sidecar that can sit next to the synth on a stand designed for a 76 key workstation.
